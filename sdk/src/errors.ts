 ...
 *
 * AMOUNT_BELOW_MIN and AMOUNT_ABOVE_MAX are legacy program-escrow policy
 * codes. The bounty-escrow contract exposes its own namespaced variants at
 * numeric codes 19 and 20.
 */
...
const CONTRACT_ERROR_MESSAGES: Record<ContractErrorCode, string> = {
  ...
  [ContractErrorCode.BOUNTY_AMOUNT_ABOVE_MAXIMUM]: 'Bounty amount is above the configured maximum',
